...
function sampleProject() {
    ...
    id: uid(), title: 'Welcome', blocks: [
      ...
      { id: uid(), type: 'heading', level: 2, text: 'Good to know' },
      {
        id: uid(), type: 'table', header: true, rows: [
          ...
          ['Reorder pages', 'Drag them in the sidebar.'],
  ...
  var pageShots = {
    id: uid(), title: 'Screenshots and pins', blocks: [
      ...
      },
      {
        id: uid(), type: 'paragraph', html: 'Pins can be referenced from any text. The chips in this sentence are live links: press ' +
          ...
          chipHtml(aSearch.id, 2, aSearch.name) + ' to find a record, and switch sections with ' +
          chipHtml(aNav.id, 3, aNav.name) + '. In the exported document each chip jumps to the pin legend under the figure.'
      },
      { id: uid(), type: 'heading', level: 2, text: 'How to annotate' },
      {
        id: uid(), type: 'list', ordered: true, html:
  ...
  var pageBlocks = {
    id: uid(), title: 'Blocks', blocks: [
      ...
      { id: uid(), type: 'heading', level: 2, text: 'Tables and dividers' },
      {
        id: uid(), type: 'table', header: true, rows: [
          ['Type', 'Best for'],
  ...
  var pageExport = {
    id: uid(), title: 'Export and PDF', blocks: [
      { id: uid(), type: 'heading', level: 2, text: 'HTML export' },
      ...
      { id: uid(), type: 'heading', level: 2, text: 'PDF' },
      ...
      { id: uid(), type: 'heading', level: 2, text: 'Markdown import' },
  ...
  return {
    ...
    maxImageWidth: 1600,
    updated: Date.now(),
    pages: [pageWelcome, pageShots, pageBlocks, pageExport]
  };
}
